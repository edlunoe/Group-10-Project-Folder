...
if __name__ == '__main__':
    train_dataset = datasets.ImageFolder(root='kaggle_dataset\\train', transform=transform_train)
    val_dataset = datasets.ImageFolder(root='kaggle_dataset\\val', transform=transform_val)
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(32 * 73 * 73, 128)  # beregn igen
        self.relu3 = nn.ReLU()
...
# Prøvede at justere vægtningen i lossfunktionen; virker umiddelbart ikke
